			...
			<div class="content-inner">
                ...
                <div id="header" class="page-header col-md-12">
                    <div class="page-header-content d-flex justify-content-sm-between justify-content-around align-items-center text-center p-sm-5 p-3 container-fluid flex-wrap">
                        ...
                        <div class="d-lg-inline-none collapse d-lg-block ms-lg-auto mx-5">
                            <div class="btn-group d-flex flex-wrap align-items-start">
                                <div class="btn-group dropstart d-flex align-items-center">
                                    <button  class="btn bg-transparent border-0 text-white mx-2" data-bs-toggle="dropdown">
                                ...
                                <a href="../trouverunclub.php" class="d-flex flex-column align-items-center justify-content-around">
                        ...
                        <button   class="px-3 py-1 bg-white border-0 d-flex align-items-center justify-content-center text-body radius-15" data-bs-toggle="modal" data-bs-target="#exampleModal">
                ...
                <div class="content p-0" id="index">
                    <div id="hautpage">
                        <div id="bandeau" class="position-relative d-flex justify-content-center align-items-center text-center">
                            ...
                            <div class="overlay-text position-absolute w-100 h-100 d-flex justify-content-center align-items-center">
                                <p class="display-1 fw-bold text-white col-lg-6">Ouvrir le sport à tous…Sans exception</p>
                            </div>
                            <div id="boutons" class="px-sm-5 pb-sm-5 pb-3 container-fluid position-absolute col-xl-1">
                                <div class="d-flex">
                                    <a href="" class="btn bg-transparent">
                                        <img src="../img/sound.png" alt="" class="img-fluid custom-img">
                                    </a>
                                
                                    <a href="" class="btn bg-transparent">
                                        <img src="../img/arrowwhitedown.png" alt="" class="img-fluid custom-img">
                                    </a>
                                </div>
                            </div>
                            
                            <div id="infos" class="px-sm-5 pb-sm-5 pb-3 container-fluid justify-content-around position-absolute text-white col-xl-5 col-lg-6 col-md-8">
                                <div class="d-flex justify-content-around" id="imgcontainer">
                                    <div class="col-5 d-flex">
                                        <img src="../img/abdo fessier 1.jpg" class="img-fluid">
                                    </div>
                                    <div class="col-5 d-flex">
                                        <img src="../img/2014 3.jpg" class="img-fluid">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-around">
                                    <div class="col-5 d-flex align-items-center justify-content-around">
                                        <img src="../img/icon_chaussures.png" class="d-md-flex d-none h50xw50">
                                        <h6 class="fw-bold ml-2">150 activités sportives à découvrir</h6>
                                    </div>
                                    <div class="verticaldivider"></div>
                                    <div class="col-5 d-flex align-items-center justify-content-around">
                                        <img src="../img/icon_france_bleu.png" class="d-md-flex d-none img-fluid h50xw50">
                                        <h6 class="fw-bold ml-2">Trouver le club le plus proche de chez vous</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-xl-3 col-sm-6 mb-4">
                                        <div class="card p-3 shadow-none text-center h-100">
                                            <div class="card-body text-white d-flex flex-column align-items-center justify-content-around">
                                                ...
                                                <p class="display-4 text-white mt-2 mb-0">140 000</h1>
                                                <h5 class="fw-bold">LICENCIÉS</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-3 col-6 mb-4">
                                        <div class="card p-3 shadow-none text-center h-100">
                                            <div class="card-body text-white d-flex flex-column align-items-center justify-content-around">
                                                ...
                                                <p class="display-4 text-white mt-2 mb-0">2 200</h1>
                                    ...
                                    <div class="col-xl-3 col-6 mb-4">
                                        <div class="card p-3 shadow-none text-center h-100">
                                            <div class="card-body text-white d-flex flex-column align-items-center justify-content-around">
                                                ...
                                                <p class="display-4 text-white mt-2 mb-0">5 200</h1>
                                    ...
                                    <div class="col-xl-3 col-6 mb-4">
                                        <div class="card p-3 shadow-none text-center h-100">
                                            <div class="card-body text-white d-flex flex-column align-items-center justify-content-around">
                                                ...
                                                <p class="display-4 text-white mt-2 mb-0">150</h1>
                                                <h5 class="fw-bold">ACTIVITÉS</h5>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-around flex-wrap col-6 p-3">
                                        <a href="#" class="btn col-lg-5 col-12 bg-white py-3 text-white shadow d-flex align-items-center justify-content-center m-3" style="background-color: #0099DC" data-bs-toggle="tab" data-bs-target="#fill-tabpanel-1">
                                            <h6 class="text-center m-0 fw-bold me-3" style="color: #0E3083;">Découvrir la Fédération</h6>
                                            <img src="../img/arrowright.png">
                                        </a>
                                        <a href="#" class="btn col-lg-5 col-12 py-3 text-white shadow d-flex align-items-center justify-content-center m-3" style="background-color: #0099DC" data-bs-toggle="tab" data-bs-target="#fill-tabpanel-1">
                                            <p class="text-center m-0 fw-bold me-3">Nos missions</p>
                                            <img src="../img/arrowright.png">
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="">
                                ...
                                <div class="d-flex flex-nowrap overflow-auto">
                                    <div class="col-xl-6 col-md-8 col-12 p-4 flex-shrink-0">
                                        <a href="../#" class="card-link">
                                            <div class="card p-0 shadow d-flex flex-column h-100">
                                                <img src="../img/AdobeStock_615798489 1.jpg" class="img-fluid" alt="Image">
                                                <div class="card-body px-5 pt-4 pb-5">
                                                    ...
                                                    <span class="fw-bold">Lire la suite <img src="../img/arrowright.png" class="ms-2" alt="Arrow Right"></span>
                                                </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-xl-3 col-md-5 col-9 p-4 flex-shrink-0">
                                        <a href="../#" class="card-link">
                                            <div class="card p-0 shadow d-flex flex-column h-100">
                                                <img src="../img/AdobeStock_121166552 1.jpg" class="img-fluid">
                                ...
                                <div class="d-flex justify-content-md-start justify-content-center mt-4 px-4">
                    ...
                    <div id="activites" class="position-relative d-flex flex-column justify-content-around align-items-center text-center col-12">
                        <div class="position-relative d-flex justify-content-center align-items-center text-center w-100 py-5">
                            ...
                            <div id="overlaytext" class="text-white container-fluid d-flex justify-content-end position-relative py-5 px-0">
                                <div class="col-12 container-fluid d-flex flex-column align-items-end">
                                    <div class="d-flex col-sm-11 flex-wrap justify-content-around">
                                        <div class="col-xl-8 col-sm-10 justify-content-start text-start container-fluid my-4">
                                            <div class="">
                                        ...
                                        <div class="col-xl-4 d-flex align-items-center justify-content-center mt-4 mt-lg-0">
                                    ...
                                    <div class="d-flex col-11 overflow-auto my-4">
                                        <a href="activites.html" class="card shadow col-xl-3 col-sm-5 col-12 d-flex justify-content-center align-items-center me-4 mb-3" id="cross">
                                        ...
                                        <a href="activites.html" class="card shadow col-xl-3 col-sm-5 col-12 d-flex justify-content-center align-items-center me-4 mb-3" id="bien-être">
                                    ...
                                    <div class="d-flex justify-content-start col-sm-11 flex-wrap">
                                        <div class="col-xxl-12 d-flex flex-wrap">
                                            <a class="btn col-xxl-2 col-lg-5 col-12 px-5 py-3 me-5 mb-4 text-white" style="background-color: #0099DC;">
                                                <span class="fw-bold me-3">Trouver un club</span>
                                                <img src="../img/arrowright.png">
                                            </a>
                                            <a class="btn col-xxl-3 col-lg-7 col-12 px-5 py-3 text-white mb-4" style="background-color: #0A66B0;">
                    ...
                    <div class="container my-5 py-5" id="imgoverlay" class="position-relative">
                        <div class="background-container d-flex justify-content-center">
                            ...
                            <div class="content col-lg-9 py-5 d-flex justify-content-lg-around justify-content-center align-items-center flex-wrap">
                                <div class="col-lg-5 d-flex flex-column align-items-sm-start align-items-center justify-content-around py-5">
                                    ...
                                    <p class="display-4 text-white col-lg-8 mt-lg-5">Trouvez un club</p>
                                ...
                                <div class="col-lg-6 col-sm-10 col-12 d-flex flex-column justify-content-around py-5">
                    ...
                    <img src="../img/logospt1000.png" class="position-absolute img-fluid">
                    <div id="formation" class="d-flex justify-content-center py-5 position-relative">
                            ...
                            <div id="overlaytext" class="text-white container-fluid d-flex justify-content-center position-relative py-5 px-0">
                                <div class="col-12 col-xxl-9 d-flex justify-content-between flex-wrap container-fluid p-sm-5">
                                    ...
                                    <div class="col-12 col-md-5 d-flex flex-column align-items-start">
                                        ...
                                        <a href="../FAQaffiliation.php" class="btn py-3 my-2 text-white col-lg-7 col-11 fw-bold text-center" style="background-color: #0099DC;">Nous rejoindre</a>
                                        <a href="../FAQaffiliation.php" class="btn py-3 my-2 text-white col-lg-7 col-11 fw-bold bg-transparent text-center" style="border: 2px solid #FFF;">Les avantages de l'affiliation</a>
                                    </div>
                                </div>
                            </div>
